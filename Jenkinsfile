      ...
      steps {
        container('docker') {
          sh """
             ...
             docker build -t eshop-demo:${env.BUILD_NUMBER} .
             docker tag eshop-demo:${env.BUILD_NUMBER} "831089310150.dkr.ecr.us-east-2.amazonaws.com/microservice:${env.BUILD_NUMBER}"
